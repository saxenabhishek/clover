...
export default function issue(props) {
    ...
    return us.map((i, k) => {
      ...
      return (
        <div key={k} className="flex justify-between">
          ...
          <button
            onClick={handelClick}
            className="rounded-md px-10 py-2 m-2 bg-custRed text-custWhite shadow-md"
          >
            Select
          </button>
        </div>
  ...
  return (
    <BasicPage val={{ text: "Issuing " + b.tra.title }}>
      <div className="Container bg-custWhite mx-auto w-3/4 p-5 text-custBlue3 flex flex-col rounded-lg shadow-xl border-4 border-custRed">
        <div className="m-3">
